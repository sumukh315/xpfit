...
export const PETS = [
  ...
  },
  {
    id: 'shadow_cat',
    name: 'Shadow Cat',
    desc: 'Haunts the gym at midnight. Earned by those who never quit.',
    cost: 450,
    costType: 'points',
  ...
  },
  {
    id: 'mini_griffin',
    name: 'Mini Griffin',
    desc: 'Half eagle, half lion — all elite. Only those who break records earn this.',
    cost: 400,
    costType: 'pr_points',
